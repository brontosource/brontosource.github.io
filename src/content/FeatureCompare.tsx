...
const FeatureCompare = () => {
    return (
        <SectionContainer sectionName="feature-compare" sectionClasses="flex flex-col gap-8 justify-between">
            <span>
                <TitleText>
                    Our Solution
                </TitleText>
                ...
                <div className='flex flex-col justify-between gap-'>
                    <div className='flex flex-col-reverse justify-center'>
                        ...
                        <div className="mockup-code text-base-100">
                            <pre><code>{`float deref(float *f) {`}</code></pre>
                            <pre><code>{`    return *f;`}</code></pre>
                            <pre><code>{`}`}</code></pre>
                        </div>
                    </div>
